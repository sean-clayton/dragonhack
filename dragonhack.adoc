...
All armor has an [term]#armor# value and a number of [term]#uses#.
You can [term]#use# your armor to reduce damage by the armor value, but after doing so you mark a [term]#use# on your armor.
When you reach your number of uses on the armor, the armor is no longer able to reduce damage and must be repaired.
...
Leather/Hide Armor::
  *Armor* 1 *Uses* 3 *Cost* 30C
Scale/Chain Armor::
  *Armor* 2 *Uses* 3 *Cost* 10C
Splint Armor::
  *Armor* 3 *Uses* 6 *Cost* 20C
Plate Armor::
  *Armor* 3 *Uses* 10 *Cost* 50C
