...
Your paths give you access to moves.
Moves have two key things to note about them: Their [term]#tier# and their XP cost.
You can always access [term]#tier I# moves and can take them as long as you spend their required XP cost.
To gain an ability in [term]#tier II# or above you must have N+2 moves of the previous [term]#tier# where N is the number of moves you already have in the [term]#tier# of the ability you are choosing.
For example, in order to gain your first [term]#tier II# ability, you must have two [term]#tier I# moves.
In order to gain a second [term]#tier III# ability, you must have at least three [term]#tier II# moves which means you must have at least four [term]#tier I# moves.
...
.Warrior Tier I Moves
* *Moves name* - Increase your HD by 1. You can take this up to 2 times.
...
.Mystic Tier I Moves
* *Moves name* - Increase your HD by 1.
* *Moves name* - Description
* *Moves name* - Description
* *Moves name* - Description
* *Moves name* - Description
...
.Dungeoneer Tier I Moves
* *Moves name* - Description
* *Moves name* - Description
* *Moves name* - Description

.Dungeoneer Tier II Moves
* *Moves name* - Description
* *Moves name* - Description

.Dungeoneer Tier III Moves
* *Moves name* - Description
...
.Beserker Tier I Moves
* *Moves name* - Description
* *Moves name* - Description
* *Moves name* - Description

.Beserker Tier II Moves
* *Moves name* - Description
* *Moves name* - Description

.Beserker Tier III Moves
* *Moves name* - Description
...
.Anti Paladin Tier I Moves
* *Moves name* - Description
* *Moves name* - Description
* *Moves name* - Description

.Anti Paladin Tier II Moves
* *Moves name* - Description
* *Moves name* - Description

.Anti Paladin Tier III Moves
* *Moves name* - Description
...
.Paladin Tier I Moves
* *Moves name* - Description
* *Moves name* - Description
* *Moves name* - Description

.Paladin Tier II Moves
* *Moves name* - Description
* *Moves name* - Description

.Paladin Tier III Moves
* *Moves name* - Description
...
.Cleric Tier II Moves
* *Moves name* - Description
* *Moves name* - Description

.Cleric Tier III Moves
* *Moves name* - Description
...
.Occultist Tier I Moves
* *Moves name* - Description
* *Moves name* - Description
* *Moves name* - Description

.Occultist Tier II Moves
* *Moves name* - Description
* *Moves name* - Description

.Occultist Tier III Moves
* *Moves name* - Description
...
When you have 500 coins, it takes up one slot.
