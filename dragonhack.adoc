...
* Three six-sided dice (d6) for each player. These are used for [term]#action dice# and [term]#oracle dice#.
...
Each PC will start with an array of attribute points: 3, 2, 1, 1, 0, -1.
