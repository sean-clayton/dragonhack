...
Add the attribute to your action die.
The total of your action die and your attribute is your action score.
...
. If you have <<_armor,[term]#armor#>> and the fiction allows for it, you can mark one wear off of the applicable armor and automatically succeed at resisting without any costs.
...
Roll [term]#+force# if resisting physical consequences, [term]#+mind# if resisting mental consequences, or [term]#+heart# if resisting any other consequences.
